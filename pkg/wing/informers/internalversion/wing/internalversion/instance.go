...
import (
	...
	internalinterfaces "github.com/sniperkit/snk.fork.tarmak/pkg/wing/informers/internalversion/internalinterfaces"
	internalversion "github.com/sniperkit/snk.fork.tarmak/pkg/wing/listers/wing/internalversion"
)
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredInstanceInformer(client internalclientset.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
...
func (f *instanceInformer) defaultInformer(client internalclientset.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
