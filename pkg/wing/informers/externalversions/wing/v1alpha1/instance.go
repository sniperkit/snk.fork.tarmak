...
import (
	...
	wing_v1alpha1 "github.com/sniperkit/snk.fork.tarmak/pkg/apis/wing/v1alpha1"
	client "github.com/sniperkit/snk.fork.tarmak/pkg/wing/client"
	internalinterfaces "github.com/sniperkit/snk.fork.tarmak/pkg/wing/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/sniperkit/snk.fork.tarmak/pkg/wing/listers/wing/v1alpha1"
)
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredInstanceInformer(client client.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
...
func (f *instanceInformer) defaultInformer(client client.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
